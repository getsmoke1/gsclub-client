  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Preload first hero banner - critical LCP resource */}
        <link rel="preload" as="image" href="/banners/mobile-1.webp" media="(max-width: 767px)" />
        <link rel="preload" as="image" href="/banners/desktop-1.webp" media="(min-width: 768px)" />
